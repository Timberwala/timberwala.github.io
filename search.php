  ...
  <header id="header" class="header">
    <div class="header_panel">
      ...
      <dl class="header_info icon-phone-1">
        <dt>Phone:</dt>
        <dd>+1 959 603 6035 (585-SUPPORT)</dd>
      </dl>
    </div>
    ...
    <div id="stuck_container" class="stuck_container">
      <ul class="social-list">
        ...
        <li>
          <a class="fa fa-facebook" href="https://www.facebook.com/timberwala"></a>
        </li>
        <li>
    ...
    <div class="container">
      <div class="row">
        <div class="grid_3">
          ...
          <ul class="list">
            ...
            <li>
              <a href='#'>Culis lacinia</a>
            </li>
            <li>
              <a href='#'>Proin dictum</a>
            </li>
            <li>
              <a href='#'>Fusce euismod</a>
            </li>
            <li>
              <a href='#'>Consequat</a>
            </li>
      ...
      <div class="row">
        ...
        <div class="grid_7 right">
          <div class="copyright">
            FOURNIER TIMBER SELLING CO © <span id="copyright-year"></span>
